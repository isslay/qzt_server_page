package com.qzt.common.mdb.configuration;
...
import com.qzt.common.mdb.DynamicDataSource;
...
public class MultipleDataSourceAutoConfiguration {
    ...
    public DynamicDataSource dynamicDataSource(@Qualifier("masterDataSource") DataSource masterDataSource,
        ...
        targetDataSources.put(SysConstant.DataSourceEnum.MASTER.getName(), masterDataSource);
        targetDataSources.put(SysConstant.DataSourceEnum.SLAVE.getName(), slaverDataSource);
