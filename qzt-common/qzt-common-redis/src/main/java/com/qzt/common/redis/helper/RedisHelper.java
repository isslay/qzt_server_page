package com.qzt.common.redis.helper;
...
public final class RedisHelper implements CacheManager {
    ...
    @Override
    public void set(String key, Serializable value, long seconds) {
    ...
    @Override
    public Long incr(String key, int icnum) {
        return redisTemplate.opsForValue().increment(key, icnum);
    }
