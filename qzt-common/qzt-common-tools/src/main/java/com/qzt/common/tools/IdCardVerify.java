...
/**
 * Created by JiaoPeng on 2019/5/27.
 */
public final class IdCardVerify {
     ...
     * @return
     */
    public static int IdentityCardVerification(String idStr) {
        if (!"".equals(idStr)) {
            idStr = idStr.toUpperCase(); //字符转大写
        }
...
//
//        System.out.println(IdentityCardVerification("65020219941025005x"));
//
//    }
