...
//		//System.out.println(md5.getMD5("123456".getBytes()) );
     ...
     * @date 2019-09-04
     */
    public static String conditionsToRemove(String str, String ch) {
        try {
            if (str != null && ch != null && !"".equals(str) && !"".equals(ch)) {
                String chr = String.valueOf(str.charAt(0));
                str = ch.equals(chr) ? str.substring(1) : str;
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @date 2019-09-27
     */
    public static String idFormat(String id, int start, int end) {
