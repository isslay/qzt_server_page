package com.qzt.common.swjtu.trans.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.qzt.common.swjtu.lang.LANG;
import com.qzt.common.swjtu.trans.AbstractTranslator;
...
public final class BaiduTranslator extends AbstractTranslator {
    ...
    private String token(String text, String gtk) {
        ...
        try {
//            FileReader reader = new FileReader("D:\\Baidu.js");
            FileReader reader = new FileReader("/opt/Baidu.js");
            engine.eval(reader);
