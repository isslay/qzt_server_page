...
public final class WebUtil {
    ...
    public static void saveCurrentUser(Object user) {
        setSession(SysConstant.CURRENT_USER, user);
    }
    ...
    public static void saveCurrentUserId(Long userId) {
        setSession(SysConstant.CURRENT_USER_ID, userId);
    }
    ...
    public static void saveCurrentUser(HttpServletRequest request, Object user) {
        setSession(request, SysConstant.CURRENT_USER, user);
    }
    ...
    public static Object getCurrentUser() {
        ...
        if (null != subject) {
            try {
                ...
                if (null != session) {
                    return session.getAttribute(SysConstant.CURRENT_USER);
                }
    ...
    public static Long getCurrentUserId() {
        ...
        if (null != subject) {
            try {
                Session session = subject.getSession();
                if (null != session) {
                    return (Long) session.getAttribute(SysConstant.CURRENT_USER_ID);
                }
            } catch (InvalidSessionException e) {
                log.error(e.getMessage(), e);
            }
