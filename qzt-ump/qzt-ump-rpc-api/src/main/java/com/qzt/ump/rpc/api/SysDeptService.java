...
public interface SysDeptService extends BaseService<SysDeptModel> {
     ...
     */
    boolean modifyDept(SysDeptModel sysDeptModel);

    /**
     * 分页查询部门
     *
     * @param page
     * @return com.baomidou.mybatisplus.plugins.Page<SysDeptModel>
     * @author RickyWang
     ...
     * @date 18/1/1 15:06:33
     */
    List<SysTreeModel> queryTree(Long id);
     ...
     *
     * @param id
     * @return java.util.List<SysDeptModel>
     * @author RickyWang
     * @date 18/1/1 15:08:09
     */
    List<SysDeptModel> querySubDept(Long id);
     ...
     */
    int querySubDeptCount(Long[] ids);
