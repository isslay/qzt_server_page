...
import com.qzt.ump.dao.mapper.SysMenuMapper;
import com.qzt.ump.dao.mapper.SysRoleMenuMapper;
import com.qzt.ump.dao.mapper.SysTreeMapper;
...
//    @Cacheable(value = UmpConstants.UmpCacheName.ROLE)
    ...
    public List<SysTreeModel> queryTree(Long id, Integer menuType) {
        List<SysTreeModel> sysTreeModelList = sysTreeMapper.selectMenuTree(id, menuType, null);
    ...
    @Override
    public Page<SysMenuModel> find(Page<SysMenuModel> page) {
        ...
        List<SysMenuModel> rb = this.sysMenuMapper.find(condition);
        PageInfo pageInfos = new PageInfo<>(rb);
        return PageDef.defPage(pageInfos, page);
    }

    @Override
    public List<SysTreeModel> queryTreeMenu(Long id, Integer menuType, Long parentId) {
        return this.sysTreeMapper.selectMenuTree(id, menuType, parentId);
    }
    ...
    public SysMenuModel add(SysMenuModel sysMenuModel) {
        ...
        menuModel.setMenuType(sysMenuModel.getMenuType());
    ...
    private SysTreeModel convertTreeModel(SysMenuModel sysMenuModel, Object[] checkedMenuIds) {
        ...
        sysTreeModel.setType(sysMenuModel.getMenuType());
