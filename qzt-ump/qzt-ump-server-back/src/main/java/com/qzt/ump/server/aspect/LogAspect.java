package com.qzt.ump.server.aspect;

import com.alibaba.fastjson.JSON;
import com.qzt.common.core.constant.SysConstant;
import com.qzt.common.core.util.RegexUtil;
...
public class LogAspect {
    ...
    @Pointcut("execution(* *..controller..*.*(..)) && @annotation(com.qzt.ump.server.annotation.SysLogOpt)")
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            //查询类型不添加日志
            if (SysConstant.LogOptEnum.QUERY.value() != sysLogModel.getOperationType()) {
    ...
    private SysLogModel logAfter(Object result, SysLogModel sysLogModel) {
        ...
        //返回结果
        if (response != null && response.code == SysConstant.ResultCodeEnum.SUCCESS.value()) {
