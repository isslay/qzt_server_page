...
public class SysParamController extends BaseController {
    ...
    @SysLogOpt(module = "参数管理", value = "参数新增", operationType = SysConstant.LogOptEnum.ADD)
    ...
    @SysLogOpt(module = "参数管理", value = "参数修改", operationType = SysConstant.LogOptEnum.MODIFY)
    ...
    @SysLogOpt(module = "参数管理", value = "参数批量删除", operationType = SysConstant.LogOptEnum.DELETE)
    ...
    public ResultModel updateRedis() {
        try {
