...
import com.qzt.ump.rpc.api.SysRoleService;
...
public class SysRoleController extends BaseController {
    ...
    @SysLogOpt(module = "角色管理", value = "角色新增", operationType = SysConstant.LogOptEnum.ADD)
    ...
    @SysLogOpt(module = "角色管理", value = "角色修改", operationType = SysConstant.LogOptEnum.MODIFY)
    ...
    @SysLogOpt(module = "角色管理", value = "角色批量删除", operationType = SysConstant.LogOptEnum.DELETE)
