 ...
 */
@RestController
@Api(value = "WebDgmReduceIntegralDetailController", description = "WebDgmReduceIntegralDetailController")
public class WebDgmReduceIntegralDetailController {
    ...
    @GetMapping("/pubapi/dgmReduceIntegralDetail/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<DgmReduceIntegralDetail> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/dgmReduceIntegralDetail/selectById")
    public Map<String, Object> selectById(String vno, String cno, Long id) {
        try {
            DgmReduceIntegralDetail entity = this.service.selectById(id);
