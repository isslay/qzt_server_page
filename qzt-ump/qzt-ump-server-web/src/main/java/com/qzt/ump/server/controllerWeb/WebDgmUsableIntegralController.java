 ...
 */
@RestController
@Api(value = "WebDgmUsableIntegralController", description = "WebDgmUsableIntegralController")
public class WebDgmUsableIntegralController {
    ...
    @GetMapping("/pubapi/dgmUsableIntegral/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<DgmUsableIntegral> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/dgmUsableIntegral/selectById")
    public Map<String, Object> selectById(String vno, String cno, Long id) {
        try {
            DgmUsableIntegral entity = this.service.selectById(id);
