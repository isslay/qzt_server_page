 ...
 */
@RestController
@Api(value = "WebDgmZxtClassController", description = "WebDgmZxtClassController")
public class WebDgmZxtClassController {
...
//    })
//    @GetMapping("/pubapi/dgmZxtClass/getListPage")
...
//            List<DgmZxtClass> records = pageModel.getRecords();
...
//    })
//    @GetMapping("/pubapi/dgmZxtClass/selectById")
//    public Map<String, Object> selectById(String vno, String cno, Long id) {
//        try {
//            DgmZxtClass entity = this.service.selectById(id);
...
//    }
    ...
    @GetMapping("/pubapi/dgmZxtClass/classList")
