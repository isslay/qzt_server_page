 ...
 */
@RestController
@Api(value = "WebDgmZxtController", description = "WebDgmZxtController")
public class WebDgmZxtController {
    ...
    @GetMapping("/pubapi/dgmZxt/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize, Long classId) {
        try {
            Map map = new HashMap();
            ...
            List<DgmZxt> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/dgmZxt/selectById")
    public Map<String, Object> selectById(String vno, String cno, Long id) {
        try {
            DgmZxt entity = this.service.selectById(id);
