 ...
 */
@RestController
@Api(value = "WebQztBusLogController", description = "WebQztBusLogController")
public class WebQztBusLogController {
    ...
    @GetMapping("/pubapi/qztBusLog/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztBusLog> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztBusLog/selectById/{id}")
    public Map<String, Object> selectById(@PathVariable Long id) {
        try {
            QztBusLog entity = this.service.selectById(id);
