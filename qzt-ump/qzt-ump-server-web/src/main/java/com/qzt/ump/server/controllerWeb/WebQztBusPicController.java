 ...
 */
@RestController
@Api(value = "WebQztBusPicController", description = "WebQztBusPicController")
public class WebQztBusPicController {
    ...
    @GetMapping("/pubapi/qztBusPic/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztBusPic> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztBusPic/selectById/{id}")
    public Map<String, Object> selectById(@PathVariable Long id) {
        try {
            QztBusPic entity = this.service.selectById(id);
