 ...
 */
@RestController
@Api(value = "WebQztGoodsBannerController", description = "WebQztGoodsBannerController")
public class WebQztGoodsBannerController {
    ...
    @GetMapping("/pubapi/qztGoodsBanner/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztGoodsBanner> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztGoodsBanner/selectById/{id}")
    public Map<String, Object> selectById(@PathVariable Long id) {
        try {
            QztGoodsBanner entity = this.service.selectById(id);
