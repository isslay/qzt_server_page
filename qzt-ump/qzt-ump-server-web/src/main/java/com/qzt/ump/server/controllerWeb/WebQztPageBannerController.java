 ...
 */
@RestController
@Api(value = "WebQztPageBannerController", description = "WebQztPageBannerController")
public class WebQztPageBannerController {
    ...
    @GetMapping("/pubapi/qztPageBanner/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztPageBanner> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztPageBanner/selectById")
    public Map<String, Object> selectById(String vno, String cno, Long id) {
        try {
            QztPageBanner entity = this.service.selectById(id);
