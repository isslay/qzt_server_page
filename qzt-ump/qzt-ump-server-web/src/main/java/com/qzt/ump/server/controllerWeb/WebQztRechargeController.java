 ...
 */
@RestController
@Api(value = "WebQztRechargeController", description = "WebQztRechargeController")
public class WebQztRechargeController {
    ...
    @GetMapping("/pubapi/qztRecharge/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztRecharge> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztRecharge/selectById")
    public Map<String, Object> selectById(String vno, String cno, Long id) {
        try {
            QztRecharge entity = this.service.selectById(id);
