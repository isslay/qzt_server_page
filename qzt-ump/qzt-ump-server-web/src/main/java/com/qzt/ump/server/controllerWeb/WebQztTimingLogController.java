 ...
 */
@RestController
@Api(value = "WebQztTimingLogController", description = "WebQztTimingLogController")
public class WebQztTimingLogController {
    ...
    @GetMapping("/pubapi/qztTimingLog/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztTimingLog> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztTimingLog/selectById/{id}")
    public Map<String, Object> selectById(@PathVariable Long id) {
        try {
            QztTimingLog entity = this.service.selectById(id);
