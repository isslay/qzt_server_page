 ...
 */
@RestController
@Api(value = "WebQztTopUpRecordController", description = "WebQztTopUpRecordController")
public class WebQztTopUpRecordController {

    @Autowired
    private ReturnUtilServer returnUtil;

    @Autowired
    private IQztTopUpRecordService service;
    ...
    @GetMapping("/pubapi/qztTopUpRecord/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztTopUpRecord> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztTopUpRecord/selectById/{id}")
    public Map<String, Object> selectById(@PathVariable Long id) {
        try {
            QztTopUpRecord entity = this.service.selectById(id);
