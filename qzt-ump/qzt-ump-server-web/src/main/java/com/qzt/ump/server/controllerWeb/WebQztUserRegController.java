 ...
 */
@RestController
@Api(value = "WebQztUserRegController", description = "WebQztUserRegController")
public class WebQztUserRegController {
    ...
    @GetMapping("/pubapi/qztUserReg/getListPage")
    public Map<String, Object> getListPage(String vno, String cno, Integer pageNum, Integer pageSize) {
        try {
            ...
            List<QztUserReg> records = pageModel.getRecords();
    ...
    @GetMapping("/pubapi/qztUserReg/selectById/{id}")
    public Map<String, Object> selectById(@PathVariable Long id) {
        try {
            QztUserReg entity = this.service.selectById(id);
