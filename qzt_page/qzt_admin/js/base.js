...
layui.define(['jquery'], function (exports) {
    ...
    $.ajaxSetup({
        ...
        beforeSend: function (evt, request, settings) {
            ...
            if (request.url.substr(0, 5).toString() == "http:" || request.url.substr(0, 6).toString() == "https:") {
                request.url = request.url;
            } else {
                request.url = '/qzt/' + request.url;
            }
        },
    ...
    var obj = {
        ...
        fastClickCheck: function (elem) {//base处理快速点击问题
            console.log($(elem).attr("clickPassValue"))
