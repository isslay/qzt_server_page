...
!function () {
    ...
    var agent = navigator.userAgent.toLowerCase(), bMobile = /mobile/i.test(agent), browser = $.browser,
        browerVer = parseFloat(browser.version), isIE = browser.msie,
        isIE11 = /trident\//i.test(agent) && (/rv:/i.test(agent) || /Netscape/i.test(agent.appName)),
        isMozilla = browser.mozilla, isWebkit = browser.webkit, isOpera = browser.opera, isChrome = browser.chrome,
        bAir = agent.indexOf(" adobeair/") > -1, xCount = 0, bShowPanel = !1, bClickCancel = !0, bShowModal = !1,
        bCheckEscInit = !1, _jPanel, _jShadow, _jCntLine, _jPanelButton, jModal, jModalShadow, layerShadow, jOverlay,
        jHideSelect, onModalRemove, editorRoot, getLang = XHEDITOR.getLang;
    ...
    var specialKeys = {
            ...
            122: "f11",
            123: "f12"
        }, arrAlign = [{v: "justifyleft"}, {v: "justifycenter"}, {v: "justifyright"}, {v: "justifyfull"}],
        arrList = [{v: "insertOrderedList"}, {v: "insertUnorderedList"}],
    ...
    var arrDbClick = {a: "Link", img: "Img", embed: "Embed"}, uploadInputname = "filedata",
        arrEntities = {"<": "&lt;", ">": "&gt;", '"': "&quot;", "®": "&reg;", "©": "&copy;"}, regEntities = /[<>"®©]/g,
        Xheditor = function (textarea, options) {
            ...
            function cleanPaste(a) {
                ...
                var h = isIE ? "pre" : "div",
                    i = $("<" + h + ' class="xhe-paste">\ufeff\ufeff</' + h + ">", _doc).appendTo(_doc.body), j = i[0],
                    k = _this.getSel(), l = _this.getRng(!0);
            ...
            function getLocalUrl(a, b, c) {
                ...
                var d = c ? $('<a href="' + c + '" />')[0] : location, e = d.protocol, f = d.host, g = d.hostname,
                    h = d.port, i = d.pathname.replace(/\\/g, "/").replace(/[^\/]+$/i, "");
            ...
            var _this = this, _text = textarea, _jText = $(_text), _jForm = _jText.closest("form"), _jTools, _jArea,
                _win, _jWin, _doc, _jDoc, bookmark, bInit = !1, bSource = !1, bFullscreen = !1, bCleanPaste = !1,
                outerScroll, bShowBlocktag = !1, sLayoutStyle = "", ev = null, timer, bDisableHoverExec = !1,
                bQuickHoverExec = !1, lastPoint = null, lastAngle = null, editorHeight = 0,
                settings = _this.settings = $.extend({}, XHEDITOR.settings, options), plugins = settings.plugins,
                strPlugins = [];
            ...
            var idCSS = "xheCSS_" + settings.skin, idContainer = "xhe" + xCount + "_container",
                idTools = "xhe" + xCount + "_Tool", idIframeArea = "xhe" + xCount + "_iframearea",
                idIframe = "xhe" + xCount + "_iframe", idFixFFCursor = "xhe" + xCount + "_fixffcursor", headHTML = "",
                bodyClass = "", skinPath = editorRoot + "xheditor_skin/" + settings.skin + "/", arrEmots = itemEmots,
                urlType = settings.urlType, urlBase = settings.urlBase, emotPath = settings.emotPath,
                emotPath = emotPath ? emotPath : editorRoot + "xheditor_emot/", selEmotGroup = "";
            ...
            this.init = function () {
                ...
                var b = _jText.outerWidth(), c = _jText.outerHeight(),
                ...
                var e, f, g = settings.background || _text.style.background, h = ['<span class="xheGStart"/>'],
                    i = /\||\//i;
                ...
                if ("write" === b) a = a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g, function (a, b, c, d, f, g, h) {
                    ...
                    if (isWebkit) for (var g = [{
                        ...
                        t: "strong"
                    }, {r: /font-style\s*:\s*italic;?/gi, t: "em"}, {
                ...
                if (c > 0 && 3 > c && /mso(-|normal)|WordDocument|<table\s+[^>]*?x:str|\s+class\s*=\s*"?xl[67]\d"/i.test(a)) {
                    a = a.replace(/<!--[\s\S]*?-->|<!(--)?\[[\s\S]+?\](--)?>|<style(\s+[^>]*?)?>[\s\S]*?<\/style>/gi, ""), a = a.replace(/\r?\n/gi, ""), isIE ? (a = a.replace(/<v:shapetype(\s+[^>]*)?>[\s\S]*<\/v:shapetype>/gi, ""), a = a.replace(/<v:shape(\s+[^>]+)?>[\s\S]*?<v:imagedata(\s+[^>]+)?>\s*<\/v:imagedata>[\s\S]*?<\/v:shape>/gi, function (a, b, c) {
                        ...
                        var c,
                            d = '<img src="' + editorRoot + 'xheditor_skin/blank.gif" _xhe_temp="true" class="wordImage"';
                ...
                var m = c("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),
                    ...
                    r = c("script,style"), s = {b: "strong", i: "em", s: "del", strike: "del"},
                    t = /<(?:\/([^\s>]+)|!([^>]*?)|([\w\-:]+)((?:"[^"]*"|'[^']*'|[^"'<>])*)\s*(\/?))>/g,
                    u = /\s*([\w\-:]+)(?:\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s]+)))?/g, v = [], w = [];
                w.last = function () {
                ...
                if (bFullscreen !== a) {
                    var b = $("#" + idContainer).find(".xheLayout"), c = $("#" + idContainer),
                        d = jQuery.browser.version, e = isIE && (6 == d || 7 == d);
                ...
                var e = $(getLang(a)), f = _this.getParent("a"), g = $("#xheLinkText", e), h = $("#xheLinkUrl", e),
                    i = $("#xheLinkTarget", e), j = $("#xheSave", e), k = _this.getSelect();
                ...
                var a = $(getLang(htmlAnchor)), b = _this.getParent("a"), c = $("#xheAnchorName", a),
                    d = $("#xheSave", a);
                if (1 === b.length) {
                ...
                var a = $(getLang(htmlImg)), b = _this.getParent("img"), c = $("#xheImgUrl", a), d = $("#xheImgAlt", a),
                    e = $("#xheImgAlign", a), f = $("#xheImgWidth", a), g = $("#xheImgHeight", a),
                    h = $("#xheImgBorder", a), i = $("#xheImgVspace", a), j = $("#xheImgHspace", a),
                    k = $("#xheSave", a);
                if (1 === b.length) {
                ...
                settings.upImgUrl && _this.uploadInit(c, settings.upImgUrl, settings.upImgExt), k.click(function () {
                    ...
                    var a = c.val();
                    if ("" !== a && "http://" !== a) {
                        var k = a.split(" "), l = d.val(), m = e.val(), n = f.val(), o = g.val(), p = h.val(),
                            q = i.val(), r = j.val();
                        if (k.length > 1) {
                ...
                var h = $(getLang(b)), i = _this.getParent('embed[type="' + c + '"],embed[classid="' + d + '"]'),
                    j = $("#xhe" + a + "Url", h), k = $("#xhe" + a + "Width", h), l = $("#xhe" + a + "Height", h),
                    m = $("#xheSave", h);
                ...
                var c = arrEmots[a], d = emotPath + a + "/", e = 0, f = [], g = "", h = c.width, i = c.height,
                    j = c.line, k = c.count, l = c.list;
                ...
                var a = $(getLang(htmlTable)), b = $("#xheTableRows", a), c = $("#xheTableColumns", a),
                    d = $("#xheTableHeaders", a), e = $("#xheTableWidth", a), f = $("#xheTableHeight", a),
                    g = $("#xheTableBorder", a), h = $("#xheTableCellSpacing", a), i = $("#xheTableCellPadding", a),
                    j = $("#xheTableAlign", a), k = $("#xheTableCaption", a), l = $("#xheSave", a);
                l.click(function () {
                    _this.loadBookmark();
                    var a, l, m = k.val(), n = g.val(), o = b.val(), p = c.val(), q = d.val(), r = e.val(), s = f.val(),
                        t = h.val(), u = i.val(), v = j.val(),
                ...
                var e = $(getLang('<span class="xheUpload"><input type="text" style="visibility:hidden;" tabindex="-1" /><input type="button" value="' + settings.upBtnText + '" class="xheBtn" tabindex="-1" /></span>')),
                    f = $(".xheBtn", e), g = settings.html5Upload, h = g ? settings.upMultiple : 1;
                ...
                var arrMsg = [], bHtml5Upload = settings.html5Upload,
                    upMultiple = bHtml5Upload ? settings.upMultiple : 1, upload, fileList, filename,
                ...
                var d = (new Date).getTime(), e = "jUploadFrame" + d, f = this,
                    ...
                    i = $(a), j = i.clone().attr("disabled", "true");
                ...
                var jContent = $('<iframe frameborder="0" src="' + url.replace(/{editorRoot}/gi, editorRoot) + (/\?/.test(url) ? "&" : "?") + "parenthost=" + location.host + '" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'),
                    jIframe = jContent.eq(0), jWait = jContent.eq(1);
                ...
                if (b.e) b.e.call(_this); else switch (a = a.toLowerCase()) {
                    ...
                    case"media":
                        ...
                        _this.showEmbed("Media", htmlMedia, "video/webm", "clsid:6bf52a52-394a-11d3-b153-00c04f79faa6", ' enablecontextmenu="false" autostart="false"', settings.upMediaUrl, settings.upMediaExt);
                        break;
                    case"hr":
                        _this.pasteHTML("<hr />");
                        break;
