layui.config({
    ...
    tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'moneyBalanceEnd', title: '有效转换金额', align: 'right', minWidth: 70, templet: '<div>{{d.changeMoney==""?"0.00":parseFloat(d.changeMoney/100).toFixed(2)}}</div>'},
            {field: 'logState', title: '剩余金额', align: 'center', minWidth: 70, templet: '<div>{{parseFloat((d.reMoney-d.giveMoney-d.changeMoney)/100).toFixed(2)}}</div>'},
