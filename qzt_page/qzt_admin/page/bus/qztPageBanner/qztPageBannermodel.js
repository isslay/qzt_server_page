...
layui.config({
    ...
    var base = layui.base,
        ...
        submitUrl = parent.pageOperation === 1 ? "back/qztPageBanner/add" : "back/qztPageBanner/modify";
    ...
    if (parent.pageOperation === 0 || parent.pageOperation === 2) {
        ...
        $.ajax({
            type: "GET",
            url: "back/qztPageBanner/query/" + parent.pkId,
            success: function (data) {
                if (data.code === 200) {
                    var rest = data.data;
                    //循环实体
