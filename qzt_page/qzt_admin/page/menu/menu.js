layui.config({
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    if (data.data.iconcls != "" && data.data.iconcls != null) {
                        iconcls = data.data.iconcls;
                        $("#icony").html(data.data.iconcls);
                    }
                } else {
    ...
    if (pageOpt === 1 || pageOpt === 2) {
        ...
        $(".parentName").click(function () {
            menuType = $("input[name='menuType']").filter(":checked").val();
            xadmin.open('选择上级菜单', 'tree_menu.html', 320, 550, null);
            /*layui.layer.open({
                type: 2,
                title: '选择上级菜单',
                shadeClose: true,
                ...
                content: 'tree_menu.html'
            });*/
        });

        //图标选择
        $("#icony").click(function () {
            xadmin.open('图标', 'unicode.html', null, null, null);
        });
