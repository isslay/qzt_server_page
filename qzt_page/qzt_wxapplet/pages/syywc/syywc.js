...
Page({
  ...
  onLoad: function (options) {
    ...
    var url = app.globalData.baseUrl + '/webapi/qztApplyTryorder/getTryOrderMess';
    var data = {
  ...
  doSubmit: function () {
    ...
    wx.request({
      //请求地址
      url: app.globalData.baseUrl + '/webapi/qztApplyTryorder/successOrder',
      data: {
        tokenId: wx.getStorageSync('tokenId'),
        userId: wx.getStorageSync('userMess').userId,
        vno: app.globalData.vno,
